...
<?php
$bucket = "ScottDWT";
$accesskey = "AKIAIE7PNXIQUBKR6QVQ"; 
$secret = "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"; 
...
<!-- ***************************  Microsoft Azure *************************** -->
    <li style="text-align: center">
        <input id="btnUploadAzure" type="button" value="Upload Image To Azure Blob Storage" onclick ="btnUploadAzure_onclick()"/></li>
<!-- ***************************  Microsoft Azure *************************** -->
