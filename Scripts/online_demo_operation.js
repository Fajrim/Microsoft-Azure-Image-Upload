...
function btnUploadS3_onclick() {
    ...
    strActionPage = "http://s3.amazonaws.com/ScottDWT/";
...
function btnUploadAzure_onclick() {
	...
	xhr.onreadystatechange = function() {
		if (xhr.readyState == 4) {
			uploadImageInner(xhr.responseText, dataBlob);
		}
	}
	var actionPageFullPath = 'QueryAzureSAS.php?imageName=' + uploadfilename;
